...
select pg_temp.check_true((select count(*)=20 and bool_and(relrowsecurity) from pg_class where relnamespace='public'::regnamespace and relname like 'sparknew_%' and relkind='r'),'RLS enabled on all 20 new tables');
